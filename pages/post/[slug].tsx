...
function Post({ post }: Props) {
  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-3xl p-5">
        ...
        <div className="mt-10">
          <PortableText
            ...
            serializers={{
              h1: (props: any) => (
                <h1 className="fond-bold my-5 text-2xl" {...props} />
              ),
              h2: (props: any) => (
                <h1 className="fond-bold my-5 text-2xl" {...props} />
              ),
              li: ({ children }: any) => (
                <li className="list-disk ml-4">{children}</li>
              ),
      ...
      {submitted ? (
        <div
          className="my-10 mx-auto flex max-w-2xl flex-col bg-yellow-500
        p-10 text-white"
        >
        ...
        >
          ...
          <label htmlFor="" className="mb-5 block">
            ...
            <textarea
              ...
              className="form-textarea blockfirst-letter mt-1 w-full rounded border py-2 px-3
            shadow outline-none ring-yellow-500 focus:ring"
              placeholder="John Appleseed"
              rows={8}
            />
          ...
          <input
            type="submit"
            className="focus:shadow-outline fond-bold
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // after 0 seconds, itll update the old cache
  }
}
